...
def getdata(dataname='circle_square',nproj=180,nmeas_proj=100,image_res=3000, D=1, nt=None, reconstruct_fbp=False, sigma_n=0, points=False, npmeas=1000):
    """
